<script lang="ts">
    ...
    const loginHref = "/login?redirectTo=/app";
    ...
    >
        <div class="min-w-0 space-y-4">
            <div class="flex flex-wrap items-center gap-2">
                <Badge variant="outline">Open Mission</Badge>
            ...
            <div class="max-w-3xl space-y-2">
                ...
                >
                    Open Mission surface connected to daemon authority.
                </h1>
        ...
        <div class="grid gap-3 sm:grid-cols-3 2xl:grid-cols-1">
            ...
            <div class="rounded-lg border bg-background p-4 shadow-xs">
                ...
                <p class="mt-2 text-sm text-muted-foreground">
                    The Open Mission app route is reading daemon-owned system state.
                </p>
            </div>
