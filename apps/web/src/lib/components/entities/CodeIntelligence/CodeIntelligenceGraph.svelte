<script lang="ts">
    ...
    } from "@flying-pillow/open-mission-core/entities/CodeIntelligence/CodeIntelligenceSchema";
    ...
    function createRelationCandidates(
        ...
        if (target.startsWith("$lib/")) {
            ...
            return [
                normalizePath(`apps/web/src/lib/${suffix}`),
        ...
        if (target.startsWith("@flying-pillow/open-mission-core/")) {
            return [
                normalizePath(
                    `packages/core/src/${target.slice("@flying-pillow/open-mission-core/".length)}`,
                ),
            ];
        }
        if (target === "@flying-pillow/open-mission-core") {
