// /apps/web/src/lib/components/entities/Stage/Stage.svelte.ts: OO browser entity for a mission workflow stage with task accessors.
import type { EntityCommandDescriptorType } from '@flying-pillow/open-mission-core/entities/Entity/EntitySchema';
import type { StageDataType } from '@flying-pillow/open-mission-core/entities/Stage/StageSchema';
