// /apps/web/src/lib/components/entities/Task/Task.svelte.ts: OO browser entity for workflow tasks exposed by hydrated mission data.
import type { EntityCommandDescriptorType } from '@flying-pillow/open-mission-core/entities/Entity/EntitySchema';
import { TaskCommandIds, type TaskConfigureCommandOptionsType, type TaskDataType, type TaskStartCommandOptionsType } from '@flying-pillow/open-mission-core/entities/Task/TaskSchema';
