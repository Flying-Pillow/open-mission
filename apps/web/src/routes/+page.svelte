			...
			>
				<div class="min-w-0">
					...
					>
						...
						software development: a local state machine, Open
						Mission control surface, and GitHub-connected governance
						layer that turns coding agents into bounded workers.
					</p>
				...
				>
					<Card.Header>
						<div class="flex items-center gap-3">
							...
							<Card.Title>Open Mission control surface</Card.Title
							>
						</div>
						<Card.Description class="leading-7">
							Open Mission gives operators the live surface for
