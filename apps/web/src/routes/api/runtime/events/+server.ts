// /apps/web/src/routes/api/runtime/events/+server.ts: Server-sent event stream that forwards existing daemon notifications for Open Mission web.
...
const appRuntimeEventsQuerySchema = z.object({
...
export const GET: RequestHandler = async ({ locals, request, url }) => {
    const query = appRuntimeEventsQuerySchema.parse({
