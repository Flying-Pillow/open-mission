// /apps/airport/web/src/routes/api/runtime/daemon/logs/+server.ts: Streams daemon log lines to Airport without daemon lifecycle control.
import * as fs from 'node:fs/promises';
import * as fsSync from 'node:fs';
import { z } from 'zod/v4';
import { getDaemonLogPath } from '@flying-pillow/mission-core/daemon/daemonPaths';
import { readDaemonLogLines } from '@flying-pillow/mission-core/daemon/runtime/DaemonLogger';
