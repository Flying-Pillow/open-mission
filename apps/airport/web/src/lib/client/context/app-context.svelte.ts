// /apps/airport/web/src/lib/client/context/app-context.svelte.ts: Thin Airport session context; entities live on the app singleton.
...
export type AppContextValue = {
    readonly app: AirportApplication;
