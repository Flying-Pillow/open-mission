...
A Mission dossier is the tracked history and control record for one Mission. It lives under `.open-mission/missions/MISSION_ID/` on the Mission branch ref and includes runtime data, events, artifacts, task definitions, and control records.
