...
Repository control state lives under .mission. The key document is .mission/settings.json, which stores operator-editable values such as Mission worktree root, instruction paths, skills paths, and default Agent runtime preferences.
