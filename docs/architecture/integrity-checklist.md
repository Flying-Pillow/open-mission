...
| Airport control plane | `airport-control-plane.md`, `tower.md` | `packages/airport/*`, `MissionSystemController.ts`, tower bootstrap files | `.mission/missions/18-*`, `specifications/airport/airport-control-plane.md` |
...
4. If a new airport target kind or gate rule exists, is it reflected in the airport page and projection logic?
...
- Repository user config must not become the canonical source of repository workflow policy.