...
Logs stay in their current role from ADR-0004.07 as daemon audit material. Process inspection stays a runtime reconciliation tool. Neither replaces daemon-owned runtime supervision state.
