...
AgentExecutionSemanticOperations owns the Agent-facing operation descriptors and Agent execution fact recording. It delegates code intelligence reads to the Code intelligence service.
