...
This ADR is the capstone for the current AgentExecution interaction family. ADR-0006.01 defines ownership vocabulary, ADR-0006.02 and ADR-0006.03 define context and messages, ADR-0006.04 through ADR-0006.06 define signal transports, ADR-0006.07 and ADR-0006.08 define log authority, and ADR-0006.09 defines scoped semantic operations. Those focused decisions remain binding, while this ADR explains how they compose into the structured-first, terminal-capable interaction model.
