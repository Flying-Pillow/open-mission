...
This keeps runtime interaction durable and inspectable while preserving a small, intentional Mission artifact model. ADR-0025 defines the semantic interaction journal as the canonical replayable AgentExecution log. Terminal recordings remain raw transport material.
