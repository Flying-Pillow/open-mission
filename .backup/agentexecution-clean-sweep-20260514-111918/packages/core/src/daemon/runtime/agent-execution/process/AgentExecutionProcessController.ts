...
import { deriveAgentExecutionInteractionCapabilities } from '../../../../entities/AgentExecution/AgentExecutionSchema.js';
...
export class AgentExecutionProcessController implements AgentExecutionProcessDriver {
    ...
    public submitPrompt(_prompt: AgentPrompt): Promise<AgentExecutionProcess> {
    ...
    private startProcess(input: {
        ...
        child.once('error', (error) => {
            void this.execution.terminateProcess(error.message);
        });
        child.once('close', (code) => {
            ...
            void this.execution.terminateProcess(`Process exited with status ${String(code ?? 'unknown')}.`);
        });
