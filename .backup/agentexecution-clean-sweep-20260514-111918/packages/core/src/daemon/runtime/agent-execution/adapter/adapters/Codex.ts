...
import type { AgentLaunchConfig } from '../../../../../entities/AgentExecution/AgentExecutionSchema.js';
...
function parseProcessOutputLine(line: string): AgentAdapterProcessOutput[] {
