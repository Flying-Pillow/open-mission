...
import { deriveAgentExecutionInteractionCapabilities } from '../AgentExecutionSchema.js';
import { deriveAgentExecutionProtocolOwner } from '../input/AgentExecutionCommunicationDescriptor.js';
...
import { AgentExecutionObservationPolicy } from '../observations/AgentExecutionObservationPolicy.js';
...
import type { AgentExecutionProcess } from '../AgentExecutionSchema.js';
...
describe('AgentExecution', () => {
    ...
    it('derives owner-addressed protocol metadata from the launch owner', () => {
    ...
    it('materializes protocol descriptors on live AgentExecution data', () => {
        ...
        expect(data.protocolDescriptor?.scope).toEqual({
            entity: 'Task',
            entityId: 'task-2',
            markerPrefix: '@task::'
        });
