...
} from './input/AgentExecutionSemanticOperationSchema.js';
...
export const AgentExecutionSignalMarkerPrefixSchema = z.literal('@agent-execution::');
export type AgentExecutionSignalMarkerPrefixType = z.infer<typeof AgentExecutionSignalMarkerPrefixSchema>;
