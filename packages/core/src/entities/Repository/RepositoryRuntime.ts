...
export class RepositoryRuntime extends Repository {
	...
	private async listVisibleGitHubRepositoriesForRequest(request?: Request) {
		return super.listVisibleGitHubRepositories(this.readRequestAuthToken(request));
	}
	...
	private async getGitHubIssueDetailForRequest(
		...
		return super.getGitHubIssueDetail(params, this.readRequestAuthToken(request));
	}
