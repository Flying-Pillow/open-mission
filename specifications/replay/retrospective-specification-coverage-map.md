...
| --- | --- | --- | --- | --- | --- |
| `specifications/mission/model/repository-layout-and-adoption.md` | normative spec | repository adoption and tracked dossier architecture | 1 | 2 | Preserve the canonical `.mission` layout, first-mission bootstrap, repository modes, repo routing, and mission dossier shape in mission 1. Mission 2 may reference it where semantic model records depend on the repository layout boundary. |
